...
// ANYTHING EVEN CLOSE TO A PRICE VALUE CAN BE RETRIVED AS A DOUBLE, A STRING WITH A SPECIFIED NUMBER OF DECIMAL PLACES,
// OR A BigDecimal
...
public class CoinbaseAPIResponse { 
	...
	public static class Currency { // NESTED SUB-CONTAINER CLASS
		...
		public String getMin_size(int decPlaces) { return new BigDecimal(this.Min_size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		...
		public void setMax_precision(String passVar) { this.Max_precision = passVar; setPrecision(Max_precision); }
		public Double getMax_precision() { return Double.valueOf(this.Max_precision); }
		public String getMax_precision(int decPlaces) { return new BigDecimal(this.Max_precision).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Products { // NESTED SUB-CONTAINER CLASS
		...
		public String getBase_min_size(int decPlaces) { return new BigDecimal(this.Base_min_size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getBase_max_size(int decPlaces) { return new BigDecimal(this.Base_max_size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getBase_max_size_asBigDecimal() { return new BigDecimal(this.Base_max_size); }
		
		private Double Base_increment;
		public void setBase_increment(Double passVar) { this.Base_increment = passVar; }
		public Double getBase_increment() { return this.Base_increment; }
		public String getBase_increment(int decPlaces) { return new BigDecimal(this.Base_increment).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getBase_increment_asBigDecimal() { return new BigDecimal(this.Base_increment); }
		
		private Double Quote_increment;
		public void setQuote_increment(Double passVar) { this.Quote_increment = passVar; }
		public Double getQuote_increment() { return this.Quote_increment; }
		public String getQuote_increment(int decPlaces) { return new BigDecimal(this.Quote_increment).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getQuote_increment_asBigDecimal() { return new BigDecimal(this.Quote_increment); }
		...
		public String getMin_market_funds(int decPlaces) { return new BigDecimal(this.Min_market_funds).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_market_funds(int decPlaces) { return new BigDecimal(this.Max_market_funds).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_slippage_percentage(int decPlaces) { return new BigDecimal(this.Max_slippage_percentage).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Details { // NESTED SUB-CONTAINER CLASS
		...
		public String getMin_withdrawal_amount(int decPlaces) { return new BigDecimal(this.Min_withdrawal_amount).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_withdrawal_amount(int decPlaces) { return new BigDecimal(this.Max_withdrawal_amount).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Data { // NESTED SUB-CONTAINER CLASS
		...
		public static class Rates { // SECOND NESTED SUB-CONTAINER CLASS
			...
			public String getRLC(int decPlaces) { return new BigDecimal(this.RLC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAMP(int decPlaces) { return new BigDecimal(this.AMP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKEEP(int decPlaces) { return new BigDecimal(this.KEEP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMKR(int decPlaces) { return new BigDecimal(this.MKR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDASH(int decPlaces) { return new BigDecimal(this.DASH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOMP(int decPlaces) { return new BigDecimal(this.COMP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSNX(int decPlaces) { return new BigDecimal(this.SNX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUSD(int decPlaces) { return new BigDecimal(this.USD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSHPING(int decPlaces) { return new BigDecimal(this.SHPING).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getINV(int decPlaces) { return new BigDecimal(this.INV).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDIA(int decPlaces) { return new BigDecimal(this.DIA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAXS(int decPlaces) { return new BigDecimal(this.AXS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCLV(int decPlaces) { return new BigDecimal(this.CLV).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXLM(int decPlaces) { return new BigDecimal(this.XLM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBCH(int decPlaces) { return new BigDecimal(this.BCH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAND(int decPlaces) { return new BigDecimal(this.BAND).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getADA(int decPlaces) { return new BigDecimal(this.ADA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJASMY(int decPlaces) { return new BigDecimal(this.JASMY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZEN(int decPlaces) { return new BigDecimal(this.ZEN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGFI(int decPlaces) { return new BigDecimal(this.GFI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGODS(int decPlaces) { return new BigDecimal(this.GODS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMPL(int decPlaces) { return new BigDecimal(this.MPL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIOTX(int decPlaces) { return new BigDecimal(this.IOTX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRARI(int decPlaces) { return new BigDecimal(this.RARI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFX(int decPlaces) { return new BigDecimal(this.FX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWCFG(int decPlaces) { return new BigDecimal(this.WCFG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXTZ(int decPlaces) { return new BigDecimal(this.XTZ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLQTY(int decPlaces) { return new BigDecimal(this.LQTY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUNI(int decPlaces) { return new BigDecimal(this.UNI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBADGER(int decPlaces) { return new BigDecimal(this.BADGER).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getENS(int decPlaces) { return new BigDecimal(this.ENS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUNFI(int decPlaces) { return new BigDecimal(this.UNFI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCTX(int decPlaces) { return new BigDecimal(this.CTX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZEC(int decPlaces) { return new BigDecimal(this.ZEC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWLUNA(int decPlaces) { return new BigDecimal(this.WLUNA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAUCTION(int decPlaces) { return new BigDecimal(this.AUCTION).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPERP(int decPlaces) { return new BigDecimal(this.PERP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUSDC(int decPlaces) { return new BigDecimal(this.USDC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSUSHI(int decPlaces) { return new BigDecimal(this.SUSHI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getATOM(int decPlaces) { return new BigDecimal(this.ATOM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBLZ(int decPlaces) { return new BigDecimal(this.BLZ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getYFII(int decPlaces) { return new BigDecimal(this.YFII).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDESO(int decPlaces) { return new BigDecimal(this.DESO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNCT(int decPlaces) { return new BigDecimal(this.NCT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUMA(int decPlaces) { return new BigDecimal(this.UMA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGALA(int decPlaces) { return new BigDecimal(this.GALA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWBTC(int decPlaces) { return new BigDecimal(this.WBTC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUSDT(int decPlaces) { return new BigDecimal(this.USDT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMASK(int decPlaces) { return new BigDecimal(this.MASK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCTSI(int decPlaces) { return new BigDecimal(this.CTSI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSTORJ(int decPlaces) { return new BigDecimal(this.STORJ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRAI(int decPlaces) { return new BigDecimal(this.RAI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSTX(int decPlaces) { return new BigDecimal(this.STX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGNT(int decPlaces) { return new BigDecimal(this.GNT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRU(int decPlaces) { return new BigDecimal(this.TRU).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRB(int decPlaces) { return new BigDecimal(this.TRB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSUKU(int decPlaces) { return new BigDecimal(this.SUKU).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getEOS(int decPlaces) { return new BigDecimal(this.EOS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGTC(int decPlaces) { return new BigDecimal(this.GTC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getEUR(int decPlaces) { return new BigDecimal(this.EUR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVGX(int decPlaces) { return new BigDecimal(this.VGX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMUSD(int decPlaces) { return new BigDecimal(this.MUSD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMATIC(int decPlaces) { return new BigDecimal(this.MATIC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREN(int decPlaces) { return new BigDecimal(this.REN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGRT(int decPlaces) { return new BigDecimal(this.GRT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLCX(int decPlaces) { return new BigDecimal(this.LCX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLOOM(int decPlaces) { return new BigDecimal(this.LOOM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getASM(int decPlaces) { return new BigDecimal(this.ASM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getICP(int decPlaces) { return new BigDecimal(this.ICP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREP(int decPlaces) { return new BigDecimal(this.REP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTBTC(int decPlaces) { return new BigDecimal(this.TBTC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getYFI(int decPlaces) { return new BigDecimal(this.YFI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUST(int decPlaces) { return new BigDecimal(this.UST).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXYO(int decPlaces) { return new BigDecimal(this.XYO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFOX(int decPlaces) { return new BigDecimal(this.FOX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLRC(int decPlaces) { return new BigDecimal(this.LRC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBOND(int decPlaces) { return new BigDecimal(this.BOND).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDDX(int decPlaces) { return new BigDecimal(this.DDX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMIR(int decPlaces) { return new BigDecimal(this.MIR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRBN(int decPlaces) { return new BigDecimal(this.RBN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSKL(int decPlaces) { return new BigDecimal(this.SKL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBTC(int decPlaces) { return new BigDecimal(this.BTC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMLN(int decPlaces) { return new BigDecimal(this.MLN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRAC(int decPlaces) { return new BigDecimal(this.TRAC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPOWR(int decPlaces) { return new BigDecimal(this.POWR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGBP(int decPlaces) { return new BigDecimal(this.GBP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPRO(int decPlaces) { return new BigDecimal(this.PRO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBICO(int decPlaces) { return new BigDecimal(this.BICO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNU(int decPlaces) { return new BigDecimal(this.NU).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETH(int decPlaces) { return new BigDecimal(this.ETH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMDT(int decPlaces) { return new BigDecimal(this.MDT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOMG(int decPlaces) { return new BigDecimal(this.OMG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFIL(int decPlaces) { return new BigDecimal(this.FIL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZRX(int decPlaces) { return new BigDecimal(this.ZRX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRGT(int decPlaces) { return new BigDecimal(this.RGT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPLU(int decPlaces) { return new BigDecimal(this.PLU).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLTC(int decPlaces) { return new BigDecimal(this.LTC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getALGO(int decPlaces) { return new BigDecimal(this.ALGO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLINK(int decPlaces) { return new BigDecimal(this.LINK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCGLD(int decPlaces) { return new BigDecimal(this.CGLD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCRO(int decPlaces) { return new BigDecimal(this.CRO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKNC(int decPlaces) { return new BigDecimal(this.KNC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCRV(int decPlaces) { return new BigDecimal(this.CRV).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREQ(int decPlaces) { return new BigDecimal(this.REQ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFET(int decPlaces) { return new BigDecimal(this.FET).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSUPER(int decPlaces) { return new BigDecimal(this.SUPER).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOGN(int decPlaces) { return new BigDecimal(this.OGN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLPT(int decPlaces) { return new BigDecimal(this.LPT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getQUICK(int decPlaces) { return new BigDecimal(this.QUICK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDNT(int decPlaces) { return new BigDecimal(this.DNT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getORN(int decPlaces) { return new BigDecimal(this.ORN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNKN(int decPlaces) { return new BigDecimal(this.NKN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPLA(int decPlaces) { return new BigDecimal(this.PLA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getARPA(int decPlaces) { return new BigDecimal(this.ARPA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBTRST(int decPlaces) { return new BigDecimal(this.BTRST).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAGLD(int decPlaces) { return new BigDecimal(this.AGLD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPAX(int decPlaces) { return new BigDecimal(this.PAX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPOLS(int decPlaces) { return new BigDecimal(this.POLS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSPELL(int decPlaces) { return new BigDecimal(this.SPELL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCHZ(int decPlaces) { return new BigDecimal(this.CHZ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBNT(int decPlaces) { return new BigDecimal(this.BNT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAT(int decPlaces) { return new BigDecimal(this.BAT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAVAX(int decPlaces) { return new BigDecimal(this.AVAX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAL(int decPlaces) { return new BigDecimal(this.BAL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAAVE(int decPlaces) { return new BigDecimal(this.AAVE).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getQNT(int decPlaces) { return new BigDecimal(this.QNT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOTI(int decPlaces) { return new BigDecimal(this.COTI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDOT(int decPlaces) { return new BigDecimal(this.DOT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCVC(int decPlaces) { return new BigDecimal(this.CVC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFORTH(int decPlaces) { return new BigDecimal(this.FORTH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNMR(int decPlaces) { return new BigDecimal(this.NMR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOXT(int decPlaces) { return new BigDecimal(this.OXT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getENJ(int decPlaces) { return new BigDecimal(this.ENJ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPOLY(int decPlaces) { return new BigDecimal(this.POLY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRLY(int decPlaces) { return new BigDecimal(this.RLY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getACH(int decPlaces) { return new BigDecimal(this.ACH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOVAL(int decPlaces) { return new BigDecimal(this.COVAL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSOL(int decPlaces) { return new BigDecimal(this.SOL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDAI(int decPlaces) { return new BigDecimal(this.DAI).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRIBE(int decPlaces) { return new BigDecimal(this.TRIBE).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMCO2(int decPlaces) { return new BigDecimal(this.MCO2).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIDEX(int decPlaces) { return new BigDecimal(this.IDEX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDOGE(int decPlaces) { return new BigDecimal(this.DOGE).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFARM(int decPlaces) { return new BigDecimal(this.FARM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getANKR(int decPlaces) { return new BigDecimal(this.ANKR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXRP(int decPlaces) { return new BigDecimal(this.XRP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGYEN(int decPlaces) { return new BigDecimal(this.GYEN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getALCX(int decPlaces) { return new BigDecimal(this.ALCX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIMX(int decPlaces) { return new BigDecimal(this.IMX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETC(int decPlaces) { return new BigDecimal(this.ETC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMANA(int decPlaces) { return new BigDecimal(this.MANA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRAD(int decPlaces) { return new BigDecimal(this.RAD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKRL(int decPlaces) { return new BigDecimal(this.KRL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAPI3(int decPlaces) { return new BigDecimal(this.API3).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSHIB(int decPlaces) { return new BigDecimal(this.SHIB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAED(int decPlaces) { return new BigDecimal(this.AED).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAFN(int decPlaces) { return new BigDecimal(this.AFN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getALL(int decPlaces) { return new BigDecimal(this.ALL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAMD(int decPlaces) { return new BigDecimal(this.AMD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getANG(int decPlaces) { return new BigDecimal(this.ANG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAOA(int decPlaces) { return new BigDecimal(this.AOA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getARS(int decPlaces) { return new BigDecimal(this.ARS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAUD(int decPlaces) { return new BigDecimal(this.AUD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAWG(int decPlaces) { return new BigDecimal(this.AWG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAZN(int decPlaces) { return new BigDecimal(this.AZN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAM(int decPlaces) { return new BigDecimal(this.BAM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBBD(int decPlaces) { return new BigDecimal(this.BBD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBDT(int decPlaces) { return new BigDecimal(this.BDT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBGN(int decPlaces) { return new BigDecimal(this.BGN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBHD(int decPlaces) { return new BigDecimal(this.BHD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBIF(int decPlaces) { return new BigDecimal(this.BIF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBMD(int decPlaces) { return new BigDecimal(this.BMD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBND(int decPlaces) { return new BigDecimal(this.BND).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBOB(int decPlaces) { return new BigDecimal(this.BOB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBRL(int decPlaces) { return new BigDecimal(this.BRL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBSD(int decPlaces) { return new BigDecimal(this.BSD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBTN(int decPlaces) { return new BigDecimal(this.BTN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBWP(int decPlaces) { return new BigDecimal(this.BWP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBYN(int decPlaces) { return new BigDecimal(this.BYN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBYR(int decPlaces) { return new BigDecimal(this.BYR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBZD(int decPlaces) { return new BigDecimal(this.BZD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCAD(int decPlaces) { return new BigDecimal(this.CAD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCDF(int decPlaces) { return new BigDecimal(this.CDF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCHF(int decPlaces) { return new BigDecimal(this.CHF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCLF(int decPlaces) { return new BigDecimal(this.CLF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCLP(int decPlaces) { return new BigDecimal(this.CLP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCNH(int decPlaces) { return new BigDecimal(this.CNH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCNY(int decPlaces) { return new BigDecimal(this.CNY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOP(int decPlaces) { return new BigDecimal(this.COP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCRC(int decPlaces) { return new BigDecimal(this.CRC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCUC(int decPlaces) { return new BigDecimal(this.CUC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCVE(int decPlaces) { return new BigDecimal(this.CVE).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCZK(int decPlaces) { return new BigDecimal(this.CZK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDJF(int decPlaces) { return new BigDecimal(this.DJF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDKK(int decPlaces) { return new BigDecimal(this.DKK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDOP(int decPlaces) { return new BigDecimal(this.DOP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDZD(int decPlaces) { return new BigDecimal(this.DZD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getEGP(int decPlaces) { return new BigDecimal(this.EGP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETB(int decPlaces) { return new BigDecimal(this.ETB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFJD(int decPlaces) { return new BigDecimal(this.FJD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFKP(int decPlaces) { return new BigDecimal(this.FKP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGBX(int decPlaces) { return new BigDecimal(this.GBX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGGP(int decPlaces) { return new BigDecimal(this.GGP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGHS(int decPlaces) { return new BigDecimal(this.GHS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGIP(int decPlaces) { return new BigDecimal(this.GIP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGMD(int decPlaces) { return new BigDecimal(this.GMD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGNF(int decPlaces) { return new BigDecimal(this.GNF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGTQ(int decPlaces) { return new BigDecimal(this.GTQ).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGYD(int decPlaces) { return new BigDecimal(this.GYD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHKD(int decPlaces) { return new BigDecimal(this.HKD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHNL(int decPlaces) { return new BigDecimal(this.HNL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHRK(int decPlaces) { return new BigDecimal(this.HRK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHTG(int decPlaces) { return new BigDecimal(this.HTG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHUF(int decPlaces) { return new BigDecimal(this.HUF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIDR(int decPlaces) { return new BigDecimal(this.IDR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getILS(int decPlaces) { return new BigDecimal(this.ILS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIMP(int decPlaces) { return new BigDecimal(this.IMP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getINR(int decPlaces) { return new BigDecimal(this.INR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIQD(int decPlaces) { return new BigDecimal(this.IQD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getISK(int decPlaces) { return new BigDecimal(this.ISK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJEP(int decPlaces) { return new BigDecimal(this.JEP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJMD(int decPlaces) { return new BigDecimal(this.JMD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJOD(int decPlaces) { return new BigDecimal(this.JOD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJPY(int decPlaces) { return new BigDecimal(this.JPY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKES(int decPlaces) { return new BigDecimal(this.KES).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKGS(int decPlaces) { return new BigDecimal(this.KGS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKHR(int decPlaces) { return new BigDecimal(this.KHR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKMF(int decPlaces) { return new BigDecimal(this.KMF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKRW(int decPlaces) { return new BigDecimal(this.KRW).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKWD(int decPlaces) { return new BigDecimal(this.KWD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKYD(int decPlaces) { return new BigDecimal(this.KYD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKZT(int decPlaces) { return new BigDecimal(this.KZT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLAK(int decPlaces) { return new BigDecimal(this.LAK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLBP(int decPlaces) { return new BigDecimal(this.LBP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLKR(int decPlaces) { return new BigDecimal(this.LKR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLRD(int decPlaces) { return new BigDecimal(this.LRD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLSL(int decPlaces) { return new BigDecimal(this.LSL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLYD(int decPlaces) { return new BigDecimal(this.LYD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMAD(int decPlaces) { return new BigDecimal(this.MAD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMDL(int decPlaces) { return new BigDecimal(this.MDL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMGA(int decPlaces) { return new BigDecimal(this.MGA).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMKD(int decPlaces) { return new BigDecimal(this.MKD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMMK(int decPlaces) { return new BigDecimal(this.MMK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMNT(int decPlaces) { return new BigDecimal(this.MNT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMOP(int decPlaces) { return new BigDecimal(this.MOP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMRO(int decPlaces) { return new BigDecimal(this.MRO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMUR(int decPlaces) { return new BigDecimal(this.MUR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMVR(int decPlaces) { return new BigDecimal(this.MVR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMWK(int decPlaces) { return new BigDecimal(this.MWK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMXN(int decPlaces) { return new BigDecimal(this.MXN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMYR(int decPlaces) { return new BigDecimal(this.MYR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMZN(int decPlaces) { return new BigDecimal(this.MZN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNAD(int decPlaces) { return new BigDecimal(this.NAD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNGN(int decPlaces) { return new BigDecimal(this.NGN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNIO(int decPlaces) { return new BigDecimal(this.NIO).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNOK(int decPlaces) { return new BigDecimal(this.NOK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNPR(int decPlaces) { return new BigDecimal(this.NPR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNZD(int decPlaces) { return new BigDecimal(this.NZD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOMR(int decPlaces) { return new BigDecimal(this.OMR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPAB(int decPlaces) { return new BigDecimal(this.PAB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPEN(int decPlaces) { return new BigDecimal(this.PEN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPGK(int decPlaces) { return new BigDecimal(this.PGK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPHP(int decPlaces) { return new BigDecimal(this.PHP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPKR(int decPlaces) { return new BigDecimal(this.PKR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPLN(int decPlaces) { return new BigDecimal(this.PLN).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPYG(int decPlaces) { return new BigDecimal(this.PYG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getQAR(int decPlaces) { return new BigDecimal(this.QAR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRON(int decPlaces) { return new BigDecimal(this.RON).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRSD(int decPlaces) { return new BigDecimal(this.RSD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRUB(int decPlaces) { return new BigDecimal(this.RUB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRWF(int decPlaces) { return new BigDecimal(this.RWF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSAR(int decPlaces) { return new BigDecimal(this.SAR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSBD(int decPlaces) { return new BigDecimal(this.SBD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSCR(int decPlaces) { return new BigDecimal(this.SCR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSEK(int decPlaces) { return new BigDecimal(this.SEK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSGD(int decPlaces) { return new BigDecimal(this.SGD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSHP(int decPlaces) { return new BigDecimal(this.SHP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSKK(int decPlaces) { return new BigDecimal(this.SKK).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSLL(int decPlaces) { return new BigDecimal(this.SLL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSOS(int decPlaces) { return new BigDecimal(this.SOS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSRD(int decPlaces) { return new BigDecimal(this.SRD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSSP(int decPlaces) { return new BigDecimal(this.SSP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSTD(int decPlaces) { return new BigDecimal(this.STD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSVC(int decPlaces) { return new BigDecimal(this.SVC).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSZL(int decPlaces) { return new BigDecimal(this.SZL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTHB(int decPlaces) { return new BigDecimal(this.THB).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTJS(int decPlaces) { return new BigDecimal(this.TJS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTMM(int decPlaces) { return new BigDecimal(this.TMM).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTMT(int decPlaces) { return new BigDecimal(this.TMT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTND(int decPlaces) { return new BigDecimal(this.TND).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTOP(int decPlaces) { return new BigDecimal(this.TOP).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRY(int decPlaces) { return new BigDecimal(this.TRY).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTTD(int decPlaces) { return new BigDecimal(this.TTD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTWD(int decPlaces) { return new BigDecimal(this.TWD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTZS(int decPlaces) { return new BigDecimal(this.TZS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUAH(int decPlaces) { return new BigDecimal(this.UAH).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUGX(int decPlaces) { return new BigDecimal(this.UGX).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUYU(int decPlaces) { return new BigDecimal(this.UYU).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUZS(int decPlaces) { return new BigDecimal(this.UZS).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVES(int decPlaces) { return new BigDecimal(this.VES).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVND(int decPlaces) { return new BigDecimal(this.VND).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVUV(int decPlaces) { return new BigDecimal(this.VUV).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWST(int decPlaces) { return new BigDecimal(this.WST).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXAF(int decPlaces) { return new BigDecimal(this.XAF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXAG(int decPlaces) { return new BigDecimal(this.XAG).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXAU(int decPlaces) { return new BigDecimal(this.XAU).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXCD(int decPlaces) { return new BigDecimal(this.XCD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXDR(int decPlaces) { return new BigDecimal(this.XDR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXOF(int decPlaces) { return new BigDecimal(this.XOF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXPD(int decPlaces) { return new BigDecimal(this.XPD).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXPF(int decPlaces) { return new BigDecimal(this.XPF).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXPT(int decPlaces) { return new BigDecimal(this.XPT).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getYER(int decPlaces) { return new BigDecimal(this.YER).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZAR(int decPlaces) { return new BigDecimal(this.ZAR).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZMW(int decPlaces) { return new BigDecimal(this.ZMW).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZWL(int decPlaces) { return new BigDecimal(this.ZWL).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBSV(int decPlaces) { return new BigDecimal(this.BSV).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETH2(int decPlaces) { return new BigDecimal(this.ETH2).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREPV2(int decPlaces) { return new BigDecimal(this.REPV2).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
			...
			public String get1inch(int decPlaces) { return new BigDecimal(this._1inch).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Wire_deposit_information { // NESTED SUB-CONTAINER CLASS
		...
		public String getHold_business_days(int decPlaces) { return new BigDecimal(this.Hold_business_days).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getHold_days(int decPlaces) { return new BigDecimal(this.Hold_days).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Available_balance { // NESTED SUB-CONTAINER CLASS
		...
		public String getAmount(int decPlaces) { return new BigDecimal(this.Amount).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getSubtotal(int decPlaces) { return new BigDecimal(this.Subtotal).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHold_balance(int decPlaces) { return new BigDecimal(this.Hold_balance).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getTaker_fee_rate(int decPlaces) { return new BigDecimal(this.Taker_fee_rate).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getRemaining_size(int decPlaces) { return new BigDecimal(this.Remaining_size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getMaker_fee_rate(int decPlaces) { return new BigDecimal(this.Maker_fee_rate).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getUSD_volume(int decPlaces) { return new BigDecimal(this.USD_volume).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getSequence(int decPlaces) { return new BigDecimal(this.Sequence).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getOpen_24h(int decPlaces) { return new BigDecimal(this.Open_24h).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getVolume_24h(int decPlaces) { return new BigDecimal(this.Volume_24h).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getLow_24h(int decPlaces) { return new BigDecimal(this.Low_24h).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHigh_24h(int decPlaces) { return new BigDecimal(this.High_24h).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getVolume_30d(int decPlaces) { return new BigDecimal(this.Volume_30d).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getBest_bid(int decPlaces) { return new BigDecimal(this.Best_bid).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getBest_ask(int decPlaces) { return new BigDecimal(this.Best_ask).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getLast_size(int decPlaces) { return new BigDecimal(this.Last_size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getPrice(int decPlaces) { return new BigDecimal(this.Price).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getSize(int decPlaces) { return new BigDecimal(this.Size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFunds(int decPlaces) { return new BigDecimal(this.Funds).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getSpecified_funds(int decPlaces) { return new BigDecimal(this.Specified_funds).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFill_fees(int decPlaces) { return new BigDecimal(this.Fill_fees).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFilled_size(int decPlaces) { return new BigDecimal(this.Filled_size).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getExecuted_value(int decPlaces) { return new BigDecimal(this.Executed_value).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getStop_price(int decPlaces) { return new BigDecimal(this.Stop_price).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFunding_amount(int decPlaces) { return new BigDecimal(this.Funding_amount).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getBalance(int decPlaces) { return new BigDecimal(this.Balance).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getAvailable(int decPlaces) { return new BigDecimal(this.Available).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHold(int decPlaces) { return new BigDecimal(this.Hold).round(new MathContext(decPlaces, RoundingMode.DOWN)).toPlainString(); }
