...
public class CoinbaseAPIResponseComparison {
	...
	public CoinbaseAPIResponseComparison(CoinbaseAPIResponse pOrigin, CoinbaseAPIResponse pComparator) {
		...
		if(origin.getSequence() != null && comparator.getSequence() != null) { // SEQUENCE USED
			
			if(origin.getSequence() < comparator.getSequence()) { // DATA IN SYNC
				compare();
				
			} else { // DATA NOT IN SYNC
				result = origin;
			}
			
		} else { // SEQUENCE NOT USED
			compare();
		}
	}
	...
	private void compare() { // COMPARISON OF ALL THESE GD VARIABLES
		...
		if(comparator.getOrders() != null) {
			result.setOrders(comparator.getOrders());
		
		} else {
			result.setOrders(origin.getOrders());
		}
		
		if(comparator.getTrades() != null) {
			result.setTrades(comparator.getTrades());
		
		} else {
			result.setTrades(origin.getTrades());
		}

		if(comparator.getOpen() != null) {
			result.setOpen(comparator.getOpen());
		
		} else {
			result.setOpen(origin.getOpen());
		}

		if(comparator.getCandles() != null) {
			result.setCandles(comparator.getCandles());
		
		} else {
			result.setCandles(origin.getCandles());
		}

		if(comparator.getOrder() != null) {
			result.setOrder(comparator.getOrder());
		
		} else {
			result.setOrder(origin.getOrder());
		}

		if(comparator.getAccount() != null) {
			result.setAccount(comparator.getAccount());
		
		} else {
			result.setAccount(origin.getAccount());
		}

		if(comparator.getAccounts() != null) {
			result.setAccounts(comparator.getAccounts());
		
		} else {
			result.setAccounts(origin.getAccounts());
		}

		if(comparator.getOrder_configuration() != null) {
			result.setOrder_configuration(comparator.getOrder_configuration());
		
		} else {
			result.setOrder_configuration(origin.getOrder_configuration());
		}

		if(comparator.getError_response() != null) {
			result.setError_response(comparator.getError_response());
		
		} else {
			result.setError_response(origin.getError_response());
		}

		if(comparator.getSuccess_response() != null) {
			result.setSuccess_response(comparator.getSuccess_response());
		
		} else {
			result.setSuccess_response(origin.getSuccess_response());
		}

		if(comparator.getFailure_reason() != null) {
			result.setFailure_reason(comparator.getFailure_reason());
		
		} else {
			result.setFailure_reason(origin.getFailure_reason());
		}

		if(comparator.getSuccess() != null) {
			result.setSuccess(comparator.getSuccess());
		
		} else {
			result.setSuccess(origin.getSuccess());
		}

		if(comparator.getEvents() != null) {
			result.setEvents(comparator.getEvents());
		
		} else {
			result.setEvents(origin.getEvents());
		}

		if(comparator.getSequence_num() != null) {
			result.setSequence_num(comparator.getSequence_num());
		
		} else {
			result.setSequence_num(origin.getSequence_num());
		}

		if(comparator.getClient_id() != null) {
			result.setClient_id(comparator.getClient_id());
		
		} else {
			result.setClient_id(origin.getClient_id());
		}
		
		if(comparator.getChannel() != null) {
			result.setChannel(comparator.getChannel());
		
		} else {
			result.setChannel(origin.getChannel());
		}
		
		if(comparator.getTickerUpdate() != null) {
			result.setTickerUpdate(comparator.getTickerUpdate());
		
		} else {
			result.setTickerUpdate(origin.getTickerUpdate());
		}

		if(comparator.getHigh() != null) {
			result.setHigh(comparator.getHigh());
		
		} else {
			result.setHigh(origin.getHigh());
		}

		if(comparator.getLow() != null) {
			result.setLow(comparator.getLow());
		
		} else {
			result.setLow(origin.getLow());
		}

		if(comparator.getLast() != null) {
			result.setLast(comparator.getLast());
		
		} else {
			result.setLast(origin.getLast());
		}

		if(comparator.getVolume() != null) {
			result.setVolume(comparator.getVolume());
		
		} else {
			result.setVolume(origin.getVolume());
		}

		if(comparator.getBase_min_size() != null) {
			result.setBase_min_size(comparator.getBase_min_size());
		
		} else {
			result.setBase_min_size(origin.getBase_min_size());
		}

		if(comparator.getBase_max_size() != null) {
			result.setBase_max_size(comparator.getBase_max_size());
		
		} else {
			result.setBase_max_size(origin.getBase_max_size());
		}

		if(comparator.getBase_increment() != null) {
			result.setBase_increment(comparator.getBase_increment());
		
		} else {
			result.setBase_increment(origin.getBase_increment());
		}

		if(comparator.getQuote_increment() != null) {
			result.setQuote_increment(comparator.getQuote_increment());
		
		} else {
			result.setQuote_increment(origin.getQuote_increment());
		}

		if(comparator.getDisplay_name() != null) {
			result.setDisplay_name(comparator.getDisplay_name());
		
		} else {
			result.setDisplay_name(origin.getDisplay_name());
		}

		if(comparator.getMin_market_funds() != null) {
			result.setMin_market_funds(comparator.getMin_market_funds());
		
		} else {
			result.setMin_market_funds(origin.getMin_market_funds());
		}

		if(comparator.getMax_market_funds() != null) {
			result.setMax_market_funds(comparator.getMax_market_funds());
		
		} else {
			result.setMax_market_funds(origin.getMax_market_funds());
		}

		if(comparator.getLimit_only() != null) {
			result.setLimit_only(comparator.getLimit_only());
		
		} else {
			result.setLimit_only(origin.getLimit_only());
		}

		if(comparator.getTrading_disabled() != null) {
			result.setTrading_disabled(comparator.getTrading_disabled());
		
		} else {
			result.setTrading_disabled(origin.getTrading_disabled());
		}

		if(comparator.getCancel_only() != null) {
			result.setCancel_only(comparator.getCancel_only());
		
		} else {
			result.setCancel_only(origin.getCancel_only());
		}

		if(comparator.getFx_stablecoin() != null) {
			result.setFx_stablecoin(comparator.getFx_stablecoin());
		
		} else {
			result.setFx_stablecoin(origin.getFx_stablecoin());
		}

		if(comparator.getMargin_enabled() != null) {
			result.setMargin_enabled(comparator.getMargin_enabled());
		
		} else {
			result.setMargin_enabled(origin.getMargin_enabled());
		}

		if(comparator.getMax_slippage_percentage() != null) {
			result.setMax_slippage_percentage(comparator.getMax_slippage_percentage());
		
		} else {
			result.setMax_slippage_percentage(origin.getMax_slippage_percentage());
		}
		...
		if(comparator.getQuote_currency() != null) {
			result.setQuote_currency(comparator.getQuote_currency());
		
		} else {
			result.setQuote_currency(origin.getQuote_currency());
		}

		if(comparator.getBase_currency() != null) {
			result.setBase_currency(comparator.getBase_currency());
		
		} else {
			result.setBase_currency(origin.getBase_currency());
		}
		...
		if(comparator.getVolume_30day() != null) {
			result.setVolume_30day(comparator.getVolume_30day());
		
		} else {
			result.setVolume_30day(origin.getVolume_30day());
		}
