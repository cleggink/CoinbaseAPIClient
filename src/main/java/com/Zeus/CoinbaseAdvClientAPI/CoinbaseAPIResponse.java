...
public class CoinbaseAPIResponse { 
	...
	public static class Currency { // NESTED SUB-CONTAINER CLASS
		...
		public String getMin_size(int digits) { return new BigDecimal(this.Min_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_precision(int digits) { return new BigDecimal(this.Max_precision).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Products { // NESTED SUB-CONTAINER CLASS
		...
		public void setProduct_type(String passVar) { this.Product_type = passVar; }
		...
		public String getBase_min_size(int digits) { return new BigDecimal(this.Base_min_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getBase_max_size(int digits) { return new BigDecimal(this.Base_max_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMin_market_funds(int digits) { return new BigDecimal(this.Min_market_funds).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_market_funds(int digits) { return new BigDecimal(this.Max_market_funds).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_slippage_percentage(int digits) { return new BigDecimal(this.Max_slippage_percentage).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Details { // NESTED SUB-CONTAINER CLASS
		...
		public String getMin_withdrawal_amount(int digits) { return new BigDecimal(this.Min_withdrawal_amount).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getMax_withdrawal_amount(int digits) { return new BigDecimal(this.Max_withdrawal_amount).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Data { // NESTED SUB-CONTAINER CLASS
		...
		public static class Rates { // SECOND NESTED SUB-CONTAINER CLASS
			...
			public String getRLC(int digits) { return new BigDecimal(this.RLC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAMP(int digits) { return new BigDecimal(this.AMP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKEEP(int digits) { return new BigDecimal(this.KEEP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMKR(int digits) { return new BigDecimal(this.MKR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDASH(int digits) { return new BigDecimal(this.DASH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOMP(int digits) { return new BigDecimal(this.COMP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSNX(int digits) { return new BigDecimal(this.SNX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUSD(int digits) { return new BigDecimal(this.USD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSHPING(int digits) { return new BigDecimal(this.SHPING).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getINV(int digits) { return new BigDecimal(this.INV).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDIA(int digits) { return new BigDecimal(this.DIA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAXS(int digits) { return new BigDecimal(this.AXS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCLV(int digits) { return new BigDecimal(this.CLV).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXLM(int digits) { return new BigDecimal(this.XLM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBCH(int digits) { return new BigDecimal(this.BCH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAND(int digits) { return new BigDecimal(this.BAND).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getADA(int digits) { return new BigDecimal(this.ADA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJASMY(int digits) { return new BigDecimal(this.JASMY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZEN(int digits) { return new BigDecimal(this.ZEN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGFI(int digits) { return new BigDecimal(this.GFI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGODS(int digits) { return new BigDecimal(this.GODS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMPL(int digits) { return new BigDecimal(this.MPL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIOTX(int digits) { return new BigDecimal(this.IOTX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRARI(int digits) { return new BigDecimal(this.RARI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFX(int digits) { return new BigDecimal(this.FX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWCFG(int digits) { return new BigDecimal(this.WCFG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXTZ(int digits) { return new BigDecimal(this.XTZ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLQTY(int digits) { return new BigDecimal(this.LQTY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUNI(int digits) { return new BigDecimal(this.UNI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBADGER(int digits) { return new BigDecimal(this.BADGER).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getENS(int digits) { return new BigDecimal(this.ENS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUNFI(int digits) { return new BigDecimal(this.UNFI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCTX(int digits) { return new BigDecimal(this.CTX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZEC(int digits) { return new BigDecimal(this.ZEC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWLUNA(int digits) { return new BigDecimal(this.WLUNA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAUCTION(int digits) { return new BigDecimal(this.AUCTION).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPERP(int digits) { return new BigDecimal(this.PERP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUSDC(int digits) { return new BigDecimal(this.USDC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSUSHI(int digits) { return new BigDecimal(this.SUSHI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getATOM(int digits) { return new BigDecimal(this.ATOM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBLZ(int digits) { return new BigDecimal(this.BLZ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getYFII(int digits) { return new BigDecimal(this.YFII).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDESO(int digits) { return new BigDecimal(this.DESO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNCT(int digits) { return new BigDecimal(this.NCT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUMA(int digits) { return new BigDecimal(this.UMA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGALA(int digits) { return new BigDecimal(this.GALA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWBTC(int digits) { return new BigDecimal(this.WBTC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUSDT(int digits) { return new BigDecimal(this.USDT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMASK(int digits) { return new BigDecimal(this.MASK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCTSI(int digits) { return new BigDecimal(this.CTSI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSTORJ(int digits) { return new BigDecimal(this.STORJ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRAI(int digits) { return new BigDecimal(this.RAI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSTX(int digits) { return new BigDecimal(this.STX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGNT(int digits) { return new BigDecimal(this.GNT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRU(int digits) { return new BigDecimal(this.TRU).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRB(int digits) { return new BigDecimal(this.TRB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSUKU(int digits) { return new BigDecimal(this.SUKU).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getEOS(int digits) { return new BigDecimal(this.EOS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGTC(int digits) { return new BigDecimal(this.GTC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getEUR(int digits) { return new BigDecimal(this.EUR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVGX(int digits) { return new BigDecimal(this.VGX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMUSD(int digits) { return new BigDecimal(this.MUSD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMATIC(int digits) { return new BigDecimal(this.MATIC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREN(int digits) { return new BigDecimal(this.REN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGRT(int digits) { return new BigDecimal(this.GRT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLCX(int digits) { return new BigDecimal(this.LCX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLOOM(int digits) { return new BigDecimal(this.LOOM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getASM(int digits) { return new BigDecimal(this.ASM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getICP(int digits) { return new BigDecimal(this.ICP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREP(int digits) { return new BigDecimal(this.REP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTBTC(int digits) { return new BigDecimal(this.TBTC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getYFI(int digits) { return new BigDecimal(this.YFI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUST(int digits) { return new BigDecimal(this.UST).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXYO(int digits) { return new BigDecimal(this.XYO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFOX(int digits) { return new BigDecimal(this.FOX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLRC(int digits) { return new BigDecimal(this.LRC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBOND(int digits) { return new BigDecimal(this.BOND).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDDX(int digits) { return new BigDecimal(this.DDX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMIR(int digits) { return new BigDecimal(this.MIR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRBN(int digits) { return new BigDecimal(this.RBN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSKL(int digits) { return new BigDecimal(this.SKL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBTC(int digits) { return new BigDecimal(this.BTC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMLN(int digits) { return new BigDecimal(this.MLN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRAC(int digits) { return new BigDecimal(this.TRAC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPOWR(int digits) { return new BigDecimal(this.POWR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGBP(int digits) { return new BigDecimal(this.GBP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPRO(int digits) { return new BigDecimal(this.PRO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBICO(int digits) { return new BigDecimal(this.BICO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNU(int digits) { return new BigDecimal(this.NU).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETH(int digits) { return new BigDecimal(this.ETH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMDT(int digits) { return new BigDecimal(this.MDT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOMG(int digits) { return new BigDecimal(this.OMG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFIL(int digits) { return new BigDecimal(this.FIL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZRX(int digits) { return new BigDecimal(this.ZRX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRGT(int digits) { return new BigDecimal(this.RGT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPLU(int digits) { return new BigDecimal(this.PLU).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLTC(int digits) { return new BigDecimal(this.LTC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getALGO(int digits) { return new BigDecimal(this.ALGO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLINK(int digits) { return new BigDecimal(this.LINK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCGLD(int digits) { return new BigDecimal(this.CGLD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCRO(int digits) { return new BigDecimal(this.CRO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKNC(int digits) { return new BigDecimal(this.KNC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCRV(int digits) { return new BigDecimal(this.CRV).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREQ(int digits) { return new BigDecimal(this.REQ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFET(int digits) { return new BigDecimal(this.FET).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSUPER(int digits) { return new BigDecimal(this.SUPER).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOGN(int digits) { return new BigDecimal(this.OGN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLPT(int digits) { return new BigDecimal(this.LPT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getQUICK(int digits) { return new BigDecimal(this.QUICK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDNT(int digits) { return new BigDecimal(this.DNT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getORN(int digits) { return new BigDecimal(this.ORN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNKN(int digits) { return new BigDecimal(this.NKN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPLA(int digits) { return new BigDecimal(this.PLA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getARPA(int digits) { return new BigDecimal(this.ARPA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBTRST(int digits) { return new BigDecimal(this.BTRST).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAGLD(int digits) { return new BigDecimal(this.AGLD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPAX(int digits) { return new BigDecimal(this.PAX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPOLS(int digits) { return new BigDecimal(this.POLS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSPELL(int digits) { return new BigDecimal(this.SPELL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCHZ(int digits) { return new BigDecimal(this.CHZ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBNT(int digits) { return new BigDecimal(this.BNT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAT(int digits) { return new BigDecimal(this.BAT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAVAX(int digits) { return new BigDecimal(this.AVAX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAL(int digits) { return new BigDecimal(this.BAL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAAVE(int digits) { return new BigDecimal(this.AAVE).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getQNT(int digits) { return new BigDecimal(this.QNT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOTI(int digits) { return new BigDecimal(this.COTI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDOT(int digits) { return new BigDecimal(this.DOT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCVC(int digits) { return new BigDecimal(this.CVC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFORTH(int digits) { return new BigDecimal(this.FORTH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNMR(int digits) { return new BigDecimal(this.NMR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOXT(int digits) { return new BigDecimal(this.OXT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getENJ(int digits) { return new BigDecimal(this.ENJ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPOLY(int digits) { return new BigDecimal(this.POLY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRLY(int digits) { return new BigDecimal(this.RLY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getACH(int digits) { return new BigDecimal(this.ACH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOVAL(int digits) { return new BigDecimal(this.COVAL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSOL(int digits) { return new BigDecimal(this.SOL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDAI(int digits) { return new BigDecimal(this.DAI).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRIBE(int digits) { return new BigDecimal(this.TRIBE).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMCO2(int digits) { return new BigDecimal(this.MCO2).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIDEX(int digits) { return new BigDecimal(this.IDEX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDOGE(int digits) { return new BigDecimal(this.DOGE).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFARM(int digits) { return new BigDecimal(this.FARM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getANKR(int digits) { return new BigDecimal(this.ANKR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXRP(int digits) { return new BigDecimal(this.XRP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGYEN(int digits) { return new BigDecimal(this.GYEN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getALCX(int digits) { return new BigDecimal(this.ALCX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIMX(int digits) { return new BigDecimal(this.IMX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETC(int digits) { return new BigDecimal(this.ETC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMANA(int digits) { return new BigDecimal(this.MANA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRAD(int digits) { return new BigDecimal(this.RAD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKRL(int digits) { return new BigDecimal(this.KRL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAPI3(int digits) { return new BigDecimal(this.API3).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSHIB(int digits) { return new BigDecimal(this.SHIB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAED(int digits) { return new BigDecimal(this.AED).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAFN(int digits) { return new BigDecimal(this.AFN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getALL(int digits) { return new BigDecimal(this.ALL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAMD(int digits) { return new BigDecimal(this.AMD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getANG(int digits) { return new BigDecimal(this.ANG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAOA(int digits) { return new BigDecimal(this.AOA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getARS(int digits) { return new BigDecimal(this.ARS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAUD(int digits) { return new BigDecimal(this.AUD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAWG(int digits) { return new BigDecimal(this.AWG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getAZN(int digits) { return new BigDecimal(this.AZN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBAM(int digits) { return new BigDecimal(this.BAM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBBD(int digits) { return new BigDecimal(this.BBD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBDT(int digits) { return new BigDecimal(this.BDT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBGN(int digits) { return new BigDecimal(this.BGN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBHD(int digits) { return new BigDecimal(this.BHD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBIF(int digits) { return new BigDecimal(this.BIF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBMD(int digits) { return new BigDecimal(this.BMD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBND(int digits) { return new BigDecimal(this.BND).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBOB(int digits) { return new BigDecimal(this.BOB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBRL(int digits) { return new BigDecimal(this.BRL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBSD(int digits) { return new BigDecimal(this.BSD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBTN(int digits) { return new BigDecimal(this.BTN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBWP(int digits) { return new BigDecimal(this.BWP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBYN(int digits) { return new BigDecimal(this.BYN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBYR(int digits) { return new BigDecimal(this.BYR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBZD(int digits) { return new BigDecimal(this.BZD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCAD(int digits) { return new BigDecimal(this.CAD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCDF(int digits) { return new BigDecimal(this.CDF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCHF(int digits) { return new BigDecimal(this.CHF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCLF(int digits) { return new BigDecimal(this.CLF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCLP(int digits) { return new BigDecimal(this.CLP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCNH(int digits) { return new BigDecimal(this.CNH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCNY(int digits) { return new BigDecimal(this.CNY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCOP(int digits) { return new BigDecimal(this.COP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCRC(int digits) { return new BigDecimal(this.CRC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCUC(int digits) { return new BigDecimal(this.CUC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCVE(int digits) { return new BigDecimal(this.CVE).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getCZK(int digits) { return new BigDecimal(this.CZK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDJF(int digits) { return new BigDecimal(this.DJF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDKK(int digits) { return new BigDecimal(this.DKK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDOP(int digits) { return new BigDecimal(this.DOP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getDZD(int digits) { return new BigDecimal(this.DZD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getEGP(int digits) { return new BigDecimal(this.EGP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETB(int digits) { return new BigDecimal(this.ETB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFJD(int digits) { return new BigDecimal(this.FJD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getFKP(int digits) { return new BigDecimal(this.FKP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGBX(int digits) { return new BigDecimal(this.GBX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGGP(int digits) { return new BigDecimal(this.GGP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGHS(int digits) { return new BigDecimal(this.GHS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGIP(int digits) { return new BigDecimal(this.GIP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGMD(int digits) { return new BigDecimal(this.GMD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGNF(int digits) { return new BigDecimal(this.GNF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGTQ(int digits) { return new BigDecimal(this.GTQ).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getGYD(int digits) { return new BigDecimal(this.GYD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHKD(int digits) { return new BigDecimal(this.HKD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHNL(int digits) { return new BigDecimal(this.HNL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHRK(int digits) { return new BigDecimal(this.HRK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHTG(int digits) { return new BigDecimal(this.HTG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getHUF(int digits) { return new BigDecimal(this.HUF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIDR(int digits) { return new BigDecimal(this.IDR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getILS(int digits) { return new BigDecimal(this.ILS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIMP(int digits) { return new BigDecimal(this.IMP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getINR(int digits) { return new BigDecimal(this.INR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getIQD(int digits) { return new BigDecimal(this.IQD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getISK(int digits) { return new BigDecimal(this.ISK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJEP(int digits) { return new BigDecimal(this.JEP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJMD(int digits) { return new BigDecimal(this.JMD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJOD(int digits) { return new BigDecimal(this.JOD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getJPY(int digits) { return new BigDecimal(this.JPY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKES(int digits) { return new BigDecimal(this.KES).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKGS(int digits) { return new BigDecimal(this.KGS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKHR(int digits) { return new BigDecimal(this.KHR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKMF(int digits) { return new BigDecimal(this.KMF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKRW(int digits) { return new BigDecimal(this.KRW).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKWD(int digits) { return new BigDecimal(this.KWD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKYD(int digits) { return new BigDecimal(this.KYD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getKZT(int digits) { return new BigDecimal(this.KZT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLAK(int digits) { return new BigDecimal(this.LAK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLBP(int digits) { return new BigDecimal(this.LBP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLKR(int digits) { return new BigDecimal(this.LKR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLRD(int digits) { return new BigDecimal(this.LRD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLSL(int digits) { return new BigDecimal(this.LSL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getLYD(int digits) { return new BigDecimal(this.LYD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMAD(int digits) { return new BigDecimal(this.MAD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMDL(int digits) { return new BigDecimal(this.MDL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMGA(int digits) { return new BigDecimal(this.MGA).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMKD(int digits) { return new BigDecimal(this.MKD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMMK(int digits) { return new BigDecimal(this.MMK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMNT(int digits) { return new BigDecimal(this.MNT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMOP(int digits) { return new BigDecimal(this.MOP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMRO(int digits) { return new BigDecimal(this.MRO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMUR(int digits) { return new BigDecimal(this.MUR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMVR(int digits) { return new BigDecimal(this.MVR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMWK(int digits) { return new BigDecimal(this.MWK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMXN(int digits) { return new BigDecimal(this.MXN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMYR(int digits) { return new BigDecimal(this.MYR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getMZN(int digits) { return new BigDecimal(this.MZN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNAD(int digits) { return new BigDecimal(this.NAD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNGN(int digits) { return new BigDecimal(this.NGN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNIO(int digits) { return new BigDecimal(this.NIO).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNOK(int digits) { return new BigDecimal(this.NOK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNPR(int digits) { return new BigDecimal(this.NPR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getNZD(int digits) { return new BigDecimal(this.NZD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getOMR(int digits) { return new BigDecimal(this.OMR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPAB(int digits) { return new BigDecimal(this.PAB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPEN(int digits) { return new BigDecimal(this.PEN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPGK(int digits) { return new BigDecimal(this.PGK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPHP(int digits) { return new BigDecimal(this.PHP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPKR(int digits) { return new BigDecimal(this.PKR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPLN(int digits) { return new BigDecimal(this.PLN).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getPYG(int digits) { return new BigDecimal(this.PYG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getQAR(int digits) { return new BigDecimal(this.QAR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRON(int digits) { return new BigDecimal(this.RON).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRSD(int digits) { return new BigDecimal(this.RSD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRUB(int digits) { return new BigDecimal(this.RUB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getRWF(int digits) { return new BigDecimal(this.RWF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSAR(int digits) { return new BigDecimal(this.SAR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSBD(int digits) { return new BigDecimal(this.SBD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSCR(int digits) { return new BigDecimal(this.SCR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSEK(int digits) { return new BigDecimal(this.SEK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSGD(int digits) { return new BigDecimal(this.SGD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSHP(int digits) { return new BigDecimal(this.SHP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSKK(int digits) { return new BigDecimal(this.SKK).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSLL(int digits) { return new BigDecimal(this.SLL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSOS(int digits) { return new BigDecimal(this.SOS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSRD(int digits) { return new BigDecimal(this.SRD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSSP(int digits) { return new BigDecimal(this.SSP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSTD(int digits) { return new BigDecimal(this.STD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSVC(int digits) { return new BigDecimal(this.SVC).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getSZL(int digits) { return new BigDecimal(this.SZL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTHB(int digits) { return new BigDecimal(this.THB).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTJS(int digits) { return new BigDecimal(this.TJS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTMM(int digits) { return new BigDecimal(this.TMM).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTMT(int digits) { return new BigDecimal(this.TMT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTND(int digits) { return new BigDecimal(this.TND).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTOP(int digits) { return new BigDecimal(this.TOP).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTRY(int digits) { return new BigDecimal(this.TRY).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTTD(int digits) { return new BigDecimal(this.TTD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTWD(int digits) { return new BigDecimal(this.TWD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getTZS(int digits) { return new BigDecimal(this.TZS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUAH(int digits) { return new BigDecimal(this.UAH).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUGX(int digits) { return new BigDecimal(this.UGX).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUYU(int digits) { return new BigDecimal(this.UYU).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getUZS(int digits) { return new BigDecimal(this.UZS).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVES(int digits) { return new BigDecimal(this.VES).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVND(int digits) { return new BigDecimal(this.VND).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getVUV(int digits) { return new BigDecimal(this.VUV).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getWST(int digits) { return new BigDecimal(this.WST).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXAF(int digits) { return new BigDecimal(this.XAF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXAG(int digits) { return new BigDecimal(this.XAG).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXAU(int digits) { return new BigDecimal(this.XAU).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXCD(int digits) { return new BigDecimal(this.XCD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXDR(int digits) { return new BigDecimal(this.XDR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXOF(int digits) { return new BigDecimal(this.XOF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXPD(int digits) { return new BigDecimal(this.XPD).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXPF(int digits) { return new BigDecimal(this.XPF).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getXPT(int digits) { return new BigDecimal(this.XPT).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getYER(int digits) { return new BigDecimal(this.YER).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZAR(int digits) { return new BigDecimal(this.ZAR).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZMW(int digits) { return new BigDecimal(this.ZMW).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getZWL(int digits) { return new BigDecimal(this.ZWL).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getBSV(int digits) { return new BigDecimal(this.BSV).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getETH2(int digits) { return new BigDecimal(this.ETH2).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String getREPV2(int digits) { return new BigDecimal(this.REPV2).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			...
			public String get1inch(int digits) { return new BigDecimal(this._1inch).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Wire_deposit_information { // NESTED SUB-CONTAINER CLASS
		...
		public String getHold_business_days(int digits) { return new BigDecimal(this.Hold_business_days).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		...
		public String getHold_days(int digits) { return new BigDecimal(this.Hold_days).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Available_balance { // NESTED SUB-CONTAINER CLASS
		...
		public String getAmount(int digits) { return new BigDecimal(this.Amount).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public static class Events { // NESTED SUB-CONTAINER CLASS

		public static class Tickers { // SECOND LEVEL NESTED SUB-CONTAINER CLASS
			...
			public String getPrice(int digits) { return new BigDecimal(this.Price).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getPrice_asBigDecimal() { return new BigDecimal(this.Price); }

			private Double Price_percent_chg_24_h;
			public void setPrice_percent_chg_24_h(Double passVar) { this.Price_percent_chg_24_h = passVar; }
			public Double getPrice_percent_chg_24_h() { return this.Price_percent_chg_24_h; }
			public String getPrice_percent_chg_24_h(int digits) { return new BigDecimal(this.Price_percent_chg_24_h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getPrice_percent_chg_24_h_asBigDecimal() { return new BigDecimal(this.Price_percent_chg_24_h); }

			private Double High_52_w;
			public void setHigh_52_w(Double passVar) { this.High_52_w = passVar; }
			public Double getHigh_52_w() { return this.High_52_w; }
			public String getHigh_52_w(int digits) { return new BigDecimal(this.High_52_w).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getHigh_52_w_asBigDecimal() { return new BigDecimal(this.High_52_w); }

			private Double Low_52_w;
			public void setLow_52_w(Double passVar) { this.Low_52_w = passVar; }
			public Double getLow_52_w() { return this.Low_52_w; }
			public String getLow_52_w(int digits) { return new BigDecimal(this.Low_52_w).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getLow_52_w_asBigDecimal() { return new BigDecimal(this.Low_52_w); }

			private Double High_24_h;
			public void setHigh_24_h(Double passVar) { this.High_24_h = passVar; }
			public Double getHigh_24_h() { return this.High_24_h; }
			public String getHigh_24_h(int digits) { return new BigDecimal(this.High_24_h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getHigh_24_h_asBigDecimal() { return new BigDecimal(this.High_24_h); }

			private Double Low_24_h;
			public void setLow_24_h(Double passVar) { this.Low_24_h = passVar; }
			public Double getLow_24_h() { return this.Low_24_h; }
			public String getLow_24_h(int digits) { return new BigDecimal(this.Low_24_h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getLow_24_h_asBigDecimal() { return new BigDecimal(this.Low_24_h); }

			private Double Volume_24_h;
			public void setVolume_24_h(Double passVar) { this.Volume_24_h = passVar; }
			public Double getVolume_24_h() { return this.Volume_24_h; }
			public String getVolume_24_h(int digits) { return new BigDecimal(this.Volume_24_h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getVolume_24_h_asBigDecimal() { return new BigDecimal(this.Volume_24_h); }
		}
		private Tickers[] Tickers; // SECOND LEVEL SUB-CONTAINER DATA
		public void setTickers(Tickers[] passVar) { this.Tickers = passVar; }
		public Tickers[] getTickers() { return this.Tickers; }
		
		public static class Subscriptions { // SECOND LEVEL NESTED SUB-CONTAINER CLASS
			
			private String[] Ticker;
			public void setTicker(String[] passVar) { this.Ticker = passVar; }
		...
		private Subscriptions Subscriptions; // SECOND LEVEL SUB-CONTAINER DATA
		public void setSubscriptions(Subscriptions passVar) { this.Subscriptions = passVar; }
		public Subscriptions getSubscriptions() { return this.Subscriptions; }
		
		private Products[] Products; // SECOND LEVEL SUB-CONTAINER DATA
		public void setProducts(Products[] passVar) { this.Products = passVar; }
		public Products[] getProducts() { return this.Products; }
	...
	private Events[] Events; // SUB-CONTAINER DATA
	public void setEvents(Events[] passVar) { this.Events = passVar; }
	public Events[] getEvents() { return this.Events; }
	
	public static class Success_response { // NESTED SUB-CONTAINER CLASS
		...
		public void setClient_order_id(String passVar) { this.Client_order_id = passVar; }
		public String getClient_order_id() { return this.Client_order_id; }
		
	}
	private Success_response Success_response; // SUB-CONTAINER DATA
	public void setSuccess_response(Success_response passVar) { this.Success_response = passVar; }
	public Success_response getSuccess_response() { return this.Success_response; }

	public static class Error_response { // NESTED SUB-CONTAINER CLASS

		private String Error;
		public void setError(String passVar) { this.Error = passVar; }
		public String getError() { return this.Error; }

		private String New_order_failure_reason;
		public void setNew_order_failure_reason(String passVar) { this.New_order_failure_reason = passVar; }
		public String getNew_order_failure_reason() { return this.New_order_failure_reason; }
		
		private String Preview_failure_reason;
		public void setPreview_failure_reason(String passVar) { this.Preview_failure_reason = passVar; }
		public String getPreview_failure_reason() { return this.Preview_failure_reason; }
	
		private String Error_details;
		public void setError_details(String passVar) { this.Error_details = passVar; }
		public String getError_details() { return this.Error_details; }
		
		private String Message;
		public void setMessage(String passVar) { this.Message = passVar; }
		public String getMessage() { return this.Message; }
	}
	private Error_response Error_response; // SUB-CONTAINER DATA
	public void setError_response(Error_response passVar) { this.Error_response = passVar; }
	public Error_response getError_response() { return this.Error_response; }
	
	public static class Market_data { // NESTED SUB-CONTAINER CLASS

		private Double Base_size;
		public void setBase_size(Double passVar) { this.Base_size = passVar; }
		public Double getBase_size() { return this.Base_size; }
		public String getBase_size(int digits) { return new BigDecimal(this.Base_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getBase_size_asBigDecimal() { return new BigDecimal(this.Base_size); }
		...
		public String getStop_price(int digits) { return new BigDecimal(this.Stop_price).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getStop_price_asBigDecimal() { return new BigDecimal(this.Stop_price); }

		private Double Limit_price;
		public void setLimit_price(Double passVar) { this.Limit_price = passVar; }
		public Double getLimit_price() { return this.Limit_price; }
		public String getLimit_price(int digits) { return new BigDecimal(this.Limit_price).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getLimit_price_asBigDecimal() { return new BigDecimal(this.Limit_price); }

		private Double Quote_size;
		public void setQuote_size(Double passVar) { this.Quote_size = passVar; }
		public Double getQuote_size() { return this.Quote_size; }
		public String getQuote_size(int digits) { return new BigDecimal(this.Quote_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getQuote_size_asBigDecimal() { return new BigDecimal(this.Quote_size); }
		...
		public void setStop_direction(String passVar) { this.Stop_direction = passVar; }
		public String getStop_direction() { return this.Stop_direction; }

		private String End_time;
		public void setEnd_time(String passVar) { this.End_time = passVar; }
		public String getEnd_time() { return this.End_time; }
	}
	
	public static class Order_configuration { // NESTED SUB-CONTAINER CLASS

		private Market_data Market_market_ioc; // SUB-CONTAINER DATA
		public void setMarket_market_ioc(Market_data passVar) { this.Market_market_ioc = passVar; }
		public Market_data getMarket_market_ioc() { return this.Market_market_ioc; }

		private Market_data Stop_limit_stop_limit_gtd; // SUB-CONTAINER DATA
		public void setStop_limit_stop_limit_gtd(Market_data passVar) { this.Stop_limit_stop_limit_gtd = passVar; }
		public Market_data getStop_limit_stop_limit_gtd() { return this.Stop_limit_stop_limit_gtd; }
		
		private Market_data Stop_limit_stop_limit_gtc; // SUB-CONTAINER DATA
		public void setStop_limit_stop_limit_gtc(Market_data passVar) { this.Stop_limit_stop_limit_gtc = passVar; }
		public Market_data getStop_limit_stop_limit_gtc() { return this.Stop_limit_stop_limit_gtc; }
		
		private Market_data Limit_limit_gtd; // SUB-CONTAINER DATA
		public void setLimit_limit_gtd(Market_data passVar) { this.Limit_limit_gtd = passVar; }
		public Market_data getLimit_limit_gtd() { return this.Limit_limit_gtd; }
		
		private Market_data Limit_limit_gtc; // SUB-CONTAINER DATA
		public void setLimit_limit_gtc(Market_data passVar) { this.Limit_limit_gtc = passVar; }
		public Market_data getLimit_limit_gtc() { return this.Limit_limit_gtc; }
		...
		public void setCreated_time(String passVar) { this.Created_time = passVar; }
		...
		public void setCompletion_percentage(Double passVar) { this.Completion_percentage = passVar; }
		public Double getCompletion_percentage() { return this.Completion_percentage; }
		public String getCompletion_percentage(int digits) { return new BigDecimal(this.Completion_percentage).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getCompletion_percentage_asBigDecimal() { return new BigDecimal(this.Completion_percentage); }
		...
		public String getFilled_size(int digits) { return new BigDecimal(this.Filled_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getFilled_size_asBigDecimal() { return new BigDecimal(this.Filled_size); }

		private Double Average_filled_price;
		public void setAverage_filled_price(Double passVar) { this.Average_filled_price = passVar; }
		public Double getAverage_filled_price() { return this.Average_filled_price; }
		public String getAverage_filled_price(int digits) { return new BigDecimal(this.Average_filled_price).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getAverage_filled_price_asBigDecimal() { return new BigDecimal(this.Average_filled_price); }

		private Double Fee;
		public void setFee(Double passVar) { this.Fee = passVar; }
		public Double getFee() { return this.Fee; }
		public String getFee(int digits) { return new BigDecimal(this.Fee).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getFee_asBigDecimal() { return new BigDecimal(this.Fee); }

		private Double Number_of_fills;
		public void setNumber_of_fills(Double passVar) { this.Number_of_fills = passVar; }
		public Double getNumber_of_fills() { return this.Number_of_fills; }
		public String getNumber_of_fills(int digits) { return new BigDecimal(this.Number_of_fills).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getNumber_of_fills_asBigDecimal() { return new BigDecimal(this.Number_of_fills); }

		private Double Filled_value;
		public void setFilled_value(Double passVar) { this.Filled_value = passVar; }
		public Double getFilled_value() { return this.Filled_value; }
		public String getFilled_value(int digits) { return new BigDecimal(this.Filled_value).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getFilled_value_asBigDecimal() { return new BigDecimal(this.Filled_value); }

		private Double Total_fees;
		public void setTotal_fees(Double passVar) { this.Total_fees = passVar; }
		public Double getTotal_fees() { return this.Total_fees; }
		public String getTotal_fees(int digits) { return new BigDecimal(this.Total_fees).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getTotal_fees_asBigDecimal() { return new BigDecimal(this.Total_fees); }

		private Double Total_value_after_fees;
		public void setTotal_value_after_fees(Double passVar) { this.Total_value_after_fees = passVar; }
		public Double getTotal_value_after_fees() { return this.Total_value_after_fees; }
		public String getTotal_value_after_fees(int digits) { return new BigDecimal(this.Total_value_after_fees).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getTotal_value_after_fees_asBigDecimal() { return new BigDecimal(this.Total_value_after_fees); }

		private Boolean Pending_cancel;
		public void setPending_cancel(Boolean passVar) { this.Pending_cancel = passVar; }
		public Boolean getPending_cancel() { return this.Pending_cancel; }

		private Boolean Size_in_quote;
		public void setSize_in_quote(Boolean passVar) { this.Size_in_quote = passVar; }
		public Boolean getSize_in_quote() { return this.Size_in_quote; }

		private Boolean Size_inclusive_of_fees;
		public void setSize_inclusive_of_fees(Boolean passVar) { this.Size_inclusive_of_fees = passVar; }
		public Boolean getSize_inclusive_of_fees() { return this.Size_inclusive_of_fees; }

		private String Trigger_status;
		public void setTrigger_status(String passVar) { this.Trigger_status = passVar; }
		public String getTrigger_status() { return this.Trigger_status; }
		...
		public void setReject_message(String passVar) { this.Reject_message = passVar; }
		public String getReject_message() { return this.Reject_message; }

		private String Cancel_message;
		public void setCancel_message(String passVar) { this.Cancel_message = passVar; }
		public String getCancel_message() { return this.Cancel_message; }
	...
	private Order_configuration Order_configuration; // SUB-CONTAINER DATA
	public void setOrder_configuration(Order_configuration passVar) { this.Order_configuration = passVar; }
	public Order_configuration getOrder_configuration() { return this.Order_configuration; }
	
	public static class Order { // NESTED SUB-CONTAINER CLASS
	...
	private Order Order; // SUB-CONTAINER DATA
	public void setOrder(Order passVar) { this.Order = passVar; }
	public Order getOrder() { return this.Order; }
	
	public static class Candles { // NESTED SUB-CONTAINER CLASS

		private String Start;
		public void setStart(String passVar) { this.Start = passVar; }
		public String getStart() { return this.Start; }
		
		private String Low;
		public void setLow(String passVar) { this.Low = passVar; }
		public String getLow() { return this.Low; }
		
		private String High;
		public void setHigh(String passVar) { this.High = passVar; }
		public String getHigh() { return this.High; }
		
		private String Open;
		public void setOpen(String passVar) { this.Open = passVar; }
		public String getOpen() { return this.Open; }
		
		private String Close;
		public void setClose(String passVar) { this.Close = passVar; }
		public String getClose() { return this.Close; }
		
		private String Volume;
		public void setVolume(String passVar) { this.Volume = passVar; }
		public String getVolume() { return this.Volume; }
	}
	private Candles Candles; // SUB-CONTAINER DATA
	public void setCandles(Candles passVar) { this.Candles = passVar; }
	public Candles getCandles() { return this.Candles; }
	
	public static class Accounts { // NESTED SUB-CONTAINER CLASS
		
		public static class AccountsData { // SECOND NESTED SUB-CONTAINER CLASS
			
			private String Uuid;
			public void setUuid(String passVar) { this.Uuid = passVar; }
			...
			public void setValue(Double passVar) { this.Value = passVar; }
			public Double getValue() { return this.Value; }
			public String getValue(int digits) { return new BigDecimal(this.Value).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
			public BigDecimal getValue_asBigDecimal() { return new BigDecimal(this.Value); }
		...
		private AccountsData Available_balance; // SUB-CONTAINER DATA
		public void setAvailable_balance(AccountsData passVar) { this.Available_balance = passVar; }
		public AccountsData getAvailable_balance() { return this.Available_balance; }

		private AccountsData Hold; // SUB-CONTAINER DATA
		public void setHold(AccountsData passVar) { this.Hold = passVar; }
		public AccountsData getHold() { return this.Hold; }

		private Boolean Default;
		public void setDefault(Boolean passVar) { this.Default = passVar; }
		public Boolean getDefault() { return this.Default; }
		...
		public void setDeleted_at(String passVar) { this.Deleted_at = passVar; }
		public String getDeleted_at() { return this.Deleted_at; }

		private Boolean Active;
		public void setActive(Boolean passVar) { this.Active = passVar; }
		public Boolean getActive() { return this.Active; }

		private Boolean Ready;
		public void setReady(Boolean passVar) { this.Ready = passVar; }
	...
	private Accounts[] Accounts; // SUB-CONTAINER DATA
	public void setAccounts(Accounts[] passVar) { this.Accounts = passVar; }
	public Accounts[] getAccounts() { return this.Accounts; }
	...
	public static class Trades {
		...
		public String getSize(int digits) { return new BigDecimal(this.Size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getSize_asBigDecimal() { return new BigDecimal(this.Size); }
		
		private Double Bid;
		public void setBid(Double passVar) { this.Bid = passVar; }
		public Double getBid() { return this.Bid; }
		public String getBid(int digits) { return new BigDecimal(this.Bid).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getBid_asBigDecimal() { return new BigDecimal(this.Bid); }
		
		private Double Ask;
		public void setAsk(Double passVar) { this.Ask = passVar; }
		public Double getAsk() { return this.Ask; }
		public String getAsk(int digits) { return new BigDecimal(this.Ask).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
		public BigDecimal getAsk_asBigDecimal() { return new BigDecimal(this.Ask); }	
	}
	private Trades[] Trades;
	public void setTrades(Trades[] passVar) { this.Trades = passVar; }
	public Trades[] getTrades() { return this.Trades; }
	
	private Order[] Orders;
	public void setOrders(Order[] passVar ) { this.Orders = passVar; }
	public Order[] getOrders() { return this.Orders; }
	
	private Accounts Account; // SUB-CONTAINER DATA
	public void setAccount(Accounts passVar) { this.Account = passVar; }
	...
	public void setCursor(String passVar) { this.Cursor = passVar; }
	public String getCursor() { return this.Cursor; }

	private String Failure_reason;
	public void setFailure_reason(String passVar) { this.Failure_reason = passVar; }
	public String getFailure_reason() { return this.Failure_reason; }
	...
	public String getOpen(int digits) { return new BigDecimal(this.Open).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHigh(int digits) { return new BigDecimal(this.High).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getLow(int digits) { return new BigDecimal(this.Low).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getLast(int digits) { return new BigDecimal(this.Last).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getVolume(int digits) { return new BigDecimal(this.Volume).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public void setSuccess(Boolean passVar) { this.Success = passVar; }
	public Boolean getSuccess() { return this.Success; }

	private Boolean Has_next;
	public void setHas_next(Boolean passVar) { this.Has_next = passVar; }
	public Boolean getHas_next() { return this.Has_next; }
	...
	public String getSubtotal(int digits) { return new BigDecimal(this.Subtotal).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHold_balance(int digits) { return new BigDecimal(this.Hold_balance).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getTaker_fee_rate(int digits) { return new BigDecimal(this.Taker_fee_rate).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getRemaining_size(int digits) { return new BigDecimal(this.Remaining_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getMaker_fee_rate(int digits) { return new BigDecimal(this.Maker_fee_rate).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getUSD_volume(int digits) { return new BigDecimal(this.USD_volume).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getSequence(int digits) { return new BigDecimal(this.Sequence).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getOpen_24h(int digits) { return new BigDecimal(this.Open_24h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getVolume_24h(int digits) { return new BigDecimal(this.Volume_24h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getLow_24h(int digits) { return new BigDecimal(this.Low_24h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHigh_24h(int digits) { return new BigDecimal(this.High_24h).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getVolume_30day(int digits) { return new BigDecimal(this.Volume_30day).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getVolume_30d(int digits) { return new BigDecimal(this.Volume_30d).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getBest_bid(int digits) { return new BigDecimal(this.Best_bid).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getBest_ask(int digits) { return new BigDecimal(this.Best_ask).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getLast_size(int digits) { return new BigDecimal(this.Last_size).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFunds(int digits) { return new BigDecimal(this.Funds).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getSpecified_funds(int digits) { return new BigDecimal(this.Specified_funds).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFill_fees(int digits) { return new BigDecimal(this.Fill_fees).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getExecuted_value(int digits) { return new BigDecimal(this.Executed_value).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getFunding_amount(int digits) { return new BigDecimal(this.Funding_amount).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getBalance(int digits) { return new BigDecimal(this.Balance).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getAvailable(int digits) { return new BigDecimal(this.Available).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	public String getHold(int digits) { return new BigDecimal(this.Hold).round(new MathContext(digits, RoundingMode.DOWN)).toPlainString(); }
	...
	private Boolean tickerUpdate;
	public void setTickerUpdate(Boolean passVar) { this.tickerUpdate = passVar; }
	public Boolean getTickerUpdate() { return this.tickerUpdate; }

	private String Channel;
	public void setChannel(String passVar) { this.Channel = passVar; }
	public String getChannel() { return this.Channel; }

	private Integer Sequence_num;
	public void setSequence_num(Integer passVar) { this.Sequence_num = passVar; }
	public Integer getSequence_num() { return this.Sequence_num; }
	
	private String Client_id;
	public void setClient_id(String passVar) { this.Client_id = passVar; }
